package com.yeting.web.service.redis;
...
public class RedisService {
    ...
    public String rpop(String key) {
        try {
            String remove = (String) redisTemplate.opsForList().rightPop(key);
            return remove;
        } catch (Exception e) {
            e.printStackTrace();
            return "";
    ...
    public List<Object> lrange(String key, long start, long end){
        try {
            List<Object> list = (List) redisTemplate.opsForList().range(key, start, end-1);
            return list;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
     ...
     * @return 成功个数
     */
    public Set<Object> szReverse(String key, Long l1, Long l2) {
        try {
     ...
     * @return 成功个数
     */
    public Double szInc(String key, Object v, Double d) {
        try {
     ...
     * @return 成功个数
     */
    public Double szGet(String key, Object v) {
        try {
     ...
     * @return 成功个数
     */
    public Long szRemove(String key, Object v) {
        try {
