...
import com.yeting.framework.common.base.FormMap;
import com.yeting.framework.common.base.PageView;
import com.yeting.framework.common.base.TableSeg;
...
public class PagePlugin implements Interceptor {
	 ...
	 * @throws SQLException
	 */
	private void setPageParameter(String sql, Connection connection, MappedStatement mappedStatement, BoundSql boundSql, Object parameterObject,
	...
	public static void main(String[] args) {
		String sql = "  select " + "	articleNo " + " from article left jion aefv where 1=(SELECT userName from ly_userinfo u where u.id=userId) "
