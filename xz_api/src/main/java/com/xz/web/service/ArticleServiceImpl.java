...
import com.xz.web.bo.f20.F12Bo;
import com.xz.web.bo.f20.F13Bo;
import com.xz.web.mapper.ArticleMapper;
...
public class ArticleServiceImpl extends BaseServiceImpl<Article> implements ArticleService {
    ...
    @Override
    public PageInfo<com.xz.web.bo.f10.F10Bo> selectMainPageFromRedis(PageInfo<com.xz.web.bo.f10.F10Bo> page, Integer startPage, Integer pageSize) {
        PageInfo<com.xz.web.bo.f10.F10Bo> pageInfo = new PageInfo<>();
        List<com.xz.web.bo.f10.F10Bo> f10BoList = new ArrayList<>();
        ...
        if(redisService.hasKey(mainIndex)){
            ...
            for(int i=0; i<list.size(); i++){
                com.xz.web.bo.f10.F10Bo f10Bo = new com.xz.web.bo.f10.F10Bo();
                f10Bo = JsonUtil.deserialize(list.get(i), com.xz.web.bo.f10.F10Bo.class);
                f10BoList.add(f10Bo);
            }
    ...
    public List<com.xz.web.bo.f10.F10Bo> selectF10BoList(PageInfo<com.xz.web.bo.f10.F10Bo> page, Integer startPage, Integer pageSize){
        PageHelper.startPage(page.getPageNum(), page.getPageSize());
        List<com.xz.web.bo.f10.F10Bo> f10BoList = articleExtMapper.selectMainPage();
        if (null == f10BoList) {
    ...
    public F10Bo selectDetailByArtId(Long artId, Integer pageSize, String openId, Integer hotCommentPageSize, Integer newCommentPageSize) {
        ...
        if (redisService.hasKey(mainIndex)) {
            ...
            for (int i = 0; i < list.size(); i++) {
                com.xz.web.bo.f10.F10Bo f10Bo1 = new com.xz.web.bo.f10.F10Bo();
                f10Bo1 = JsonUtil.deserialize(list.get(i), com.xz.web.bo.f10.F10Bo.class);
