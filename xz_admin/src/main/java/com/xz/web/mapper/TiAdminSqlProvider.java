...
import com.xz.web.entity.TiAdminExample.Criteria;
import com.xz.web.entity.TiAdminExample.Criterion;
import com.xz.web.entity.TiAdminExample;
import java.util.List;
import java.util.Map;

public class TiAdminSqlProvider {
     ...
     */
    public String countByExample(TiAdminExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("ti_admin");
     ...
     * @mbggenerated Sat May 12 18:36:05 CST 2018
     */
    public String deleteByExample(TiAdminExample example) {
        BEGIN();
        DELETE_FROM("ti_admin");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Sat May 12 18:36:05 CST 2018
     */
    public String insertSelective(TiAdmin record) {
        BEGIN();
        INSERT_INTO("ti_admin");
     ...
     * @mbggenerated Sat May 12 18:36:05 CST 2018
     */
    public String selectByExample(TiAdminExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TiAdmin record = (TiAdmin) parameter.get("record");
        TiAdminExample example = (TiAdminExample) parameter.get("example");
     ...
     * @mbggenerated Sat May 12 18:36:05 CST 2018
     */
    public String updateByPrimaryKeySelective(TiAdmin record) {
        BEGIN();
        UPDATE("ti_admin");
     ...
     * @mbggenerated Sat May 12 18:36:05 CST 2018
     */
    protected void applyWhere(TiAdminExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
