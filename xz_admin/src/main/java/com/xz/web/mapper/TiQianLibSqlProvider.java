...
import com.xz.web.entity.TiQianLibExample.Criteria;
import com.xz.web.entity.TiQianLibExample.Criterion;
import com.xz.web.entity.TiQianLibExample;
import java.util.List;
import java.util.Map;

public class TiQianLibSqlProvider {
     ...
     */
    public String countByExample(TiQianLibExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("ti_qian_lib");
     ...
     * @mbggenerated Sat May 12 22:20:50 CST 2018
     */
    public String deleteByExample(TiQianLibExample example) {
        BEGIN();
        DELETE_FROM("ti_qian_lib");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Sat May 12 22:20:50 CST 2018
     */
    public String insertSelective(TiQianLib record) {
        BEGIN();
        INSERT_INTO("ti_qian_lib");
     ...
     * @mbggenerated Sat May 12 22:20:50 CST 2018
     */
    public String selectByExample(TiQianLibExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TiQianLib record = (TiQianLib) parameter.get("record");
        TiQianLibExample example = (TiQianLibExample) parameter.get("example");
     ...
     * @mbggenerated Sat May 12 22:20:50 CST 2018
     */
    public String updateByPrimaryKeySelective(TiQianLib record) {
        BEGIN();
        UPDATE("ti_qian_lib");
     ...
     * @mbggenerated Sat May 12 22:20:50 CST 2018
     */
    protected void applyWhere(TiQianLibExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
